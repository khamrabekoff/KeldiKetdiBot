...
Часть поведения задаётся не кодом, а настройками в базе клиента — например,
видит ли сотрудник свой заработок. Их админ переключает прямо в боте,
в ⚙️ Sozlamalar. Значения по умолчанию рассчитаны так, чтобы новый клиент
работал как первый.
